...
public class AdminInterface {
    public void adminOptopons(){
        ...
        System.out.println("2 - Add new Van");
        System.out.println("3 - Remove a Van");
        System.out.println("4 - Informations about reservations"); // (Pawel -informacja ktore samochody sa wolne lub zajete w danym terminie I kto je wypozyczyl, ewentualnie tak jak Lukasz zucil temat czy van wymaga servisowania, i zwrot vanow od klientow i anulowanie rezerwacji)
